...
Mau Apa Banh 🗿`.trim(), wm, 'Menu', '#menu', 'Owner', '#owner', m)
}
    ...
    if (new Date() * 1 - setting.status > 1000) {
        ...
        await this.setStatus(`Hai Saya Group Assistant, Ketik #menu Untuk Mengaksed Bot || Aktif selama ${uptime} || Mode: ${global.opts['self'] ? 'Private' : setting.groupOnly ? 'Group' : 'Publik'}`).catch(_ => _)
